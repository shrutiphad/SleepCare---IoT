...
export default function BrainMonitor() {
  ...
  const handleDownload = async () => {
    try {
      setDownloading(true);
      const response = await fetch(`${API_URL}/api/download/brain`);
      ...
      alert("Brain report download failed.");
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-cyan-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          <Button className={`bg-gradient-to-r ${currentMode.gradient} text-white`} onClick={() => navigate("/history/brain")}>
            View History
          </Button>
